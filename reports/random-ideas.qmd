...
- Main issue is how to incorporate sampling weights in plots

- Ok for plot  summaries (bars, boxplots, etc)    
...
p6 <- ggplot(apipop) + geom_point(aes(y=api00, x=avg.ed), alpha=.1 ) + labs(title='population', x = '', y = '')
